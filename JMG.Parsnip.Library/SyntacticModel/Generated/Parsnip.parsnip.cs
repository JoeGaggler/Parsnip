...
namespace JMG.Parsnip.SyntacticModel.Generated
{
	...
	public class Parsnip
	{
		...
		public static ParsnipDefinition Parse(String input, IParsnipRuleFactory factory)
		{
			...
			var state = states[0];
			var result = ParseRule_Definition(state, factory);
		...
		private static ParseResult<ParsnipDefinition> ParseRule_Definition(PackratState state, IParsnipRuleFactory factory)
		{
		...
		private class PackratState
		{
			...
			internal readonly int inputPosition;
